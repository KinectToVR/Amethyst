	...
	winrt::Microsoft::UI::Xaml::UIElement const& show_el, const bool show, const DWORD delay_ms)
{
	...
	// Check now
	bool updateFound = false; // Assume up-to-date
...
namespace winrt::KinectToVR::implementation
{
	MainWindow::MainWindow()
	{
		...
		checkUpdates(UpdateItem(), false, 2000);
	}
}

void winrt::KinectToVR::implementation::MainWindow::NavView_Loaded(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
...
void winrt::KinectToVR::implementation::MainWindow::NavView_ItemInvoked(winrt::Microsoft::UI::Xaml::Controls::NavigationView const& sender, winrt::Microsoft::UI::Xaml::Controls::NavigationViewItemInvokedEventArgs const& args)
{
	NavView_Navigate(
...
void winrt::KinectToVR::implementation::MainWindow::ContentFrame_NavigationFailed(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::Navigation::NavigationFailedEventArgs const& e)
{
	throw winrt::hresult_error(
		E_FAIL, winrt::hstring(L"Failed to load Page ") + e.SourcePageType().Name);
}

void winrt::KinectToVR::implementation::MainWindow::NavView_BackRequested(winrt::Microsoft::UI::Xaml::Controls::NavigationView const& sender, winrt::Microsoft::UI::Xaml::Controls::NavigationViewBackRequestedEventArgs const& args)
{
	TryGoBack();
}
...
void winrt::KinectToVR::implementation::MainWindow::Exit_Tapped(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::Input::TappedRoutedEventArgs const& e)
{
	// Save and Exit with 0
	exit(0);
}

void winrt::KinectToVR::implementation::MainWindow::Minimize_Tapped(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::Input::TappedRoutedEventArgs const& e)
{
...
Windows::Foundation::IAsyncAction winrt::KinectToVR::implementation::MainWindow::Update_Tapped(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::Input::TappedRoutedEventArgs const& e)
{
	// Cache UI Flyout
...
void winrt::KinectToVR::implementation::MainWindow::InstallLaterButton_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
	UpdateFlyout().Hide();
}

void winrt::KinectToVR::implementation::MainWindow::InstallNowButton_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
	UpdateFlyout().Hide();
}
